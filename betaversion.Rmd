...
ggplot(data = combined_data, aes(x = Year)) +
  ...
  theme_minimal() +
  labs(
    title = "Dutch GDP Growth and Unemployment Rates (2015-2025)",
    x = "Year",
    y = "Rate (%)",
...
ggplot() +
  ...
  theme_minimal() +
  labs(title = "Unemployment in Europe (2020)", x = "Longitude", y = "Latitude")
```


*Figure 2: Unemployment rates in 2020 across Western European countries.*
...
ggplot(data = youth_data, aes(x = Demographic_Group, y = Unemployment_Rate, fill = Demographic_Group)) +
  ...
  labs(
    title = "Dutch Youth vs. Total Unemployment (2015-2025)",
    x = NULL,
    y = "Unemployment Rate (%)"
  )
```
...
*Figure 4: Year-on-year change in the Netherlands unemployment rate, 2015-2025.*
